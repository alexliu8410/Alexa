...
function handleLaunchRequest(context){
	let options = {};
	options.speechText = "Welcome to Greeting skill. Using our skill you can greet your guests. Whom you want to greet? ",
	options.reprompText = "You can say for example, say hello to John. ",
...
function handleQuoteIntent(request,context,session){
	...
	getQuote(function(quote,err){
		if(err){
			...
			options.reprompText = "You can say yes or one more";
